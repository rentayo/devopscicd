...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2022 at 03:41 PM
...
-- Database: `devopsexam`
--
CREATE DATABASE IF NOT EXISTS `devopsexam` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `devopsexam`;
...
('root', '[{\"db\":\"devopsexam\",\"table\":\"users\"}]');
...
('root', '2022-08-17 12:06:55', '{\"Console\\/Mode\":\"collapse\"}');
